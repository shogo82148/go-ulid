...
// compile type checks
var _ encoding.BinaryAppender = ULID{}
var _ encoding.BinaryMarshaler = ULID{}
var _ encoding.BinaryUnmarshaler = (*ULID)(nil)
var _ encoding.TextAppender = ULID{}
var _ encoding.TextMarshaler = ULID{}
var _ encoding.TextUnmarshaler = (*ULID)(nil)
...
func TestScan(t *testing.T) {
	t.Run("[]byte", func(t *testing.T) {
		var id ULID
		if err := id.Scan([]byte{0x01, 0x56, 0x3e, 0x3a, 0xb5, 0xd3, 0xd6, 0x76, 0x4c, 0x61, 0xef, 0xb9, 0x93, 0x02, 0xbd, 0x5b}); err != nil {
			t.Fatal(err)
		}
		want := ULID{0x01, 0x56, 0x3e, 0x3a, 0xb5, 0xd3, 0xd6, 0x76, 0x4c, 0x61, 0xef, 0xb9, 0x93, 0x02, 0xbd, 0x5b}
		if id != want {
